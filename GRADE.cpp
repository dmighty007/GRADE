...
int main(int argc, char* argv[])
{
    ...
    int in_theta=0, in_fr=0, in_dt=0, in_r=0, in_F4=0,in_AF4=0,in_Cage=0, in_d1=0, in_d2=0, in_s1=0, in_s2=0;         //This parameter is for whether theta is given as input parameter (1) or taken as default value (0).
    ...
    while ( argi < argc )
    {
        ...
        switch ( *args )
        {
            case '-':
                ...
                else if (strcmp(args, "-af4") == 0 || strcmp(args, "-AF4") == 0)
                {
                    in_AF4 = 1;
                    AF4 = "YES" ;
                    if(argi < argc )AF4 =argv[argi];
                    if(AF4 == "no" || AF4 == "No" || AF4 == "NO") {in_AF4=0; AF4 = "NO";}
                }
                else if (strcmp(args, "-cage") == 0 || strcmp(args, "-Cage") == 0)
                {
                    in_Cage = 1;
                    Cage = "YES" ;
                    if(argi < argc )Cage =argv[argi];
                    if(Cage == "no" || Cage == "No" || Cage == "NO") {in_Cage=0; Cage = "NO";}
                }
    ...
    if (in_AF4 == 1)  {cout << " -af4 " << "YES" ;}
    if (in_Cage == 1)  {cout << " -cage " << "YES" ;}
    ...
    ofstream outFile_F5;
    if(in_AF4 == 1)                          //If F4 flag option is on, open a file for F4 as a function of time.
    {
        remove("AllF4.xvg");       //Remove any existing F4.xvg file and create a new one. 
        outFile_F5.open("AllF4.xvg", ofstream::app);
        outFile_F5 << "# --------------------------------------- \n" ;
        outFile_F5 << "#|F4 value \t|Z coordinate \t|" << endl;
        outFile_F5 << "# --------------------------------------- \n" ;
    ...
    fileIN.close();
    if( in_Cage == 1)outFile.close();
    
    if( in_F4 == 1 )outFile_F4.close();
    if( in_AF4 == 1 )outFile_F5.close();
